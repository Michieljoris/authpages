...
module.exports = {
    ...
    "homepage": "https://github.com/michieljoris/authpages",
    ...
    "repository": {
        "type": "git",
        "url": "https://github.com/michieljoris/authpages.git"
    },
    ...
    "licenses": [
        {
            "type": "MIT",
            "url": "http://github.com/michieljoris/authpages/blob/master/LICENSE.txt"
        }
    ],
    ...
    //Installs a binary script called authpages which is linked to
    //./bin/authpages in the local package.

    //If we have installed this package globally using npm install authpages
    //-g we will be able to call this new command authpages from anywhere on
    //our system.
    "bin": {
	// "commit": "bin/authpages.js"
    },
    ...
    "scripts": {
        ...
        "docs": "node node_modules/.bin/docco src/authpages.js"
    }
};
